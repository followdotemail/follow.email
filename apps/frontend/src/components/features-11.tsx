...
export default function Features() {
  return (
    <section className="dark:bg-background  py-16 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto grid gap-2 sm:grid-cols-5">
          <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl aspect-square">
            <CardHeader>
