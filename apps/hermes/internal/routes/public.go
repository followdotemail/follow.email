...
func SetupPublicRoutes(router *gin.RouterGroup, cfg *config.Config, authHandler *handlers.AuthHandler, emailHandler *handlers.EmailHandler) {
	...
	// Email rendering helper endpoints
	router.POST("/emails/process-content", emailHandler.ProcessEmailContent)
}
