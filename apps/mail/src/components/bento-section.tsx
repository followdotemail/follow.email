...
export function BentoSection() {
  ...
  return (
    <section className="w-full px-2 flex flex-col justify-center items-center overflow-visible bg-transparent max-w-6xl  mx-auto">
      <div className="w-full py-8 relative flex flex-col justify-start items-start gap-6">
