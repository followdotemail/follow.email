...
export default function FooterSection() {
    return (
        <footer className="bg-background border-b py-8 sm:py-20 relative border mt-16">
                ...
                <div className="grid gap-12 md:grid-cols-5">
                    <div className="space-y-6 md:col-span-2">
                        <Link
                            href="/"
                            aria-label="go home"
                            className="size-fit flex gap-2">
                            <AppLogo /> <span className='font-medium text-lg'>follow</span>
                        </Link>
