"use client";
import { plans } from "@/constants/price-data";
            ...
            <div className="mx-auto mt-10 flex w-full flex-col items-start justify-center gap-8 sm:flex-row">
              {plans.map((plan: Plan) => {
                ...
                return (
                  ...
                  >
                    <CardHeader className="space-y-4 rounded-[18px] bg-muted  p-6 shadow-md [.border-b]:border-zinc-200/60 dark:[.border-b]:border-zinc-800">
                      ...
                      <div className="mb-3 flex items-end gap-2">
                        ...
                        />
                        <span className="mb-2 text-sm text-zinc-300">
                          {price === 0
                            ? "[Free forever]"
                            : isYearly
                              ? "/ year"
